...
| Tests | 300 |
| Mutations broken and caught | 65 of 65 |
...
python3 -m pytest tests -q           # 300 tests, no cloud project needed
python3 tests/mutate_check.py        # 65 mutations; every one must be caught
```
