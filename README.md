...
| Tests | 257 |
| Mutations broken and caught | 55 of 55 |
...
python3 -m pytest tests -q           # 257 tests, no cloud project needed
python3 tests/mutate_check.py        # 55 mutations; every one must be caught
```
